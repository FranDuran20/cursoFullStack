...
public class Guia9_Ej2 {
    ...
    public static void main(String[] args) {
        ...
        ServicioJuego play = new ServicioJuego();
        Juego jugar = new Juego();
        ArrayList<Jugador> participantes = new ArrayList();
        Revolver r = new Revolver();
        r = sr.llenarRevolver();
        System.out.print("Indique cuantos jugadores participaran > ");
        int jug = leer.nextInt();
        for (int i = 1; i <= jug; i++) {
            participantes.add(sj.crearJugador());
        }
        jugar = play.llenarJuego(r, participantes);
        play.ronda(jugar);
    }
